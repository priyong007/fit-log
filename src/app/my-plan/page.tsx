...
const MyplanPage = () => {
  const { addplan, saveLater, setAddPlan, setSaveLater } =
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      onClick={() => {
                        toast.warn(`"${work.name}" removed Workout plan`);
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      onClick={() => {
                        toast.warn(`"${work.name}" removed saved plan`);
                        setSaveLater(
                          saveLater.filter(
